...
for (i in 1:length(sample_sizes)) {
  data_subset <- data[1:sample_sizes[i],]
  means[i] <- mean(data_subset$statistiknote_w1, na.rm = T
                   )
}
print(means)
### do it in list of lists
```
:::
...
**The power of nested loops:** We tested 9 combinations (3 × 3) with just a few lines of code!
